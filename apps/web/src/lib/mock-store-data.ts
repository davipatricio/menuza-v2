...
export interface OrderItem {
  id: string;
  code: string;
  /** Owning customer. The join key; `customerName` is a denormalized label. */
  customerId: string;
  customerName: string;
  total: number;
  status: OrderStatus;
...
/** Per-customer order totals, derived from `MOCK_ORDERS` (single source of truth). */
...
export const MOCK_ORDERS: OrderItem[] = [
  ...
  },
  {
    ...
    code: "ORD-111",
    customerId: "11",
    customerName: "Paula Nogueira",
    total: 132.9,
    status: "AWAITING_PAYMENT",
    createdAt: "2026-09-20 13:30",
  },
  {
    id: "12",
    code: "ORD-112",
    customerId: "12",
    customerName: "Tiago Barros",
    total: 88.5,
    status: "PAID",
    createdAt: "2026-09-20 13:35",
  },
];
...
export const MOCK_CUSTOMERS: CustomerItem[] = [
  ...
  },
  {
    ...
    phone: "+55 21 92222-7777",
  },
  {
    id: "8",
    name: "Rafael Ramos",
    email: "rafael@example.com",
    phone: "+55 31 91111-8888",
  },
  {
    id: "9",
    name: "Juliana Alves",
